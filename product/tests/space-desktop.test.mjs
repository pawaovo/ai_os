...
test("space desktop V1.0 page exposes readiness and forge controls", async () => {
  ...
  assert.match(i18nSource, /"nav\.agents": "智能体"/);
  ...
  assert.match(i18nSource, /"dynamic\.system\.remoteSessionCreatedBody": "已为 \{\{principal\}\} 创建远程桥接会话。"/);
  assert.match(i18nSource, /"dynamic\.system\.runAlready": "当前运行已\{\{status\}\}。"/);
